...
import MtnMobileChart from './mtnMobileChart';
import { telcomtnmobileData } from 'data/chart-data/mtnMobile';

const MtnMobile = (): ReactElement => {
