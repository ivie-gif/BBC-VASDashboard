...
import AirtelChart from './airtelMobileChart';
import { telcoairtelData } from 'data/chart-data/airtelMobile';

const AirtelMobile = (): ReactElement => {
